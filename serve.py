...
urls = (
    '/testcase/(RGraph|Treemap|Icicle|Hypertree|Spacetree|PhyloJiVE|ForceDirected|ForceDirected3D|Sunburst|AreaChart|BarChart|PieChart|TimeGraph|HeatMap|Other)/([0-9]+)/?', 'testcase',
)
